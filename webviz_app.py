...
# This file was generated by root on 2020-10-05 with Python executable
        ...
        children=[
            ...
            dcc.Tab(id="logo",
                className="styledLogo",children=[
                  standard_plugins.BannerImage(**{'image': PosixPath('/usr/src/webviz-subsurface-testdata/webviz_examples/content/reek_image.jpg'), 'title': 'Reek FMU Webviz example'}).plugin_layout(contact_person=None),
                  standard_plugins.Markdown(**{'markdown_file': PosixPath('/usr/src/webviz-subsurface-testdata/webviz_examples/content/front_page.md')}).plugin_layout(contact_person=None)
                  ],
            ),
            dcc.Tab(id="how_was_this_made",label="How was this made?",
                selected_className="selectedButton",
                className="styledButton",children=[
                  standard_plugins.Markdown(**{'markdown_file': PosixPath('/usr/src/webviz-subsurface-testdata/webviz_examples/content/how_was_this_made.md')}).plugin_layout(contact_person=None),
                  standard_plugins.SyntaxHighlighter(**{'filename': PosixPath('/usr/src/webviz-subsurface-testdata/webviz_examples/webviz-full-demo.yml'), 'dark_theme': True}).plugin_layout(contact_person=None)
                  ],
            ),
            ...
            dcc.Tab(id="simulation_time_series",label="Simulation time series",
                selected_className="selectedButton",
                className="styledButton",children=[
                  standard_plugins.ReservoirSimulationTimeSeries(app=app, **{'ensembles': ['iter-0', 'iter-1', 'iter-2', 'iter-3'], 'obsfile': PosixPath('/usr/src/webviz-subsurface-testdata/reek_history_match/share/observations/observations.yml'), 'options': {'vector1': 'WOPR:OP_1', 'visualization': 'statistics'}}).plugin_layout(contact_person=None)
                  ],
            ),
            dcc.Tab(id="regional_simulation_time_series",label="Regional simulation time series",
                selected_className="selectedButton",
                className="styledButton",children=[
                  standard_plugins.ReservoirSimulationTimeSeriesRegional(app=app, **{'ensembles': ['iter-0', 'iter-1', 'iter-2', 'iter-3'], 'fipfile': PosixPath('/usr/src/webviz-subsurface-testdata/reek_history_match/share/regions/fip.yaml')}).plugin_layout(contact_person=None)
                  ],
            ),
            ...
            dcc.Tab(id="history_match_iknu_test",label="History match (IKNU Test)",
                selected_className="selectedButton",
                className="styledButton",children=[
                  standard_plugins.HistoryMatch(app=app, **{'observation_file': PosixPath('/usr/src/webviz-subsurface-testdata/reek_history_match/share/observations/observations.yml'), 'ensembles': ['iter-0', 'iter-1', 'iter-2', 'iter-3']}).plugin_layout(contact_person=None)
                  ],
            ),
            dcc.Tab(id="relative_permeability",label="Relative permeability",
                selected_className="selectedButton",
                className="styledButton",children=[
                  standard_plugins.RelativePermeability(app=app, **{'ensembles': ['iter-0', 'iter-1', 'iter-2', 'iter-3'], 'relpermfile': 'share/results/tables/relperm.csv', 'scalfile': PosixPath('/usr/src/webviz-subsurface-testdata/reek_history_match/share/scal/scalreek.csv')}).plugin_layout(contact_person=None)
                  ],
            ),
            ...
            dcc.Tab(id="seg-y_viewer",label="SEG-Y viewer",
                selected_className="selectedButton",
                className="styledButton",children=[
                  standard_plugins.SegyViewer(app=app, **{'segyfiles': [PosixPath('/usr/src/webviz-subsurface-testdata/observed_data/seismic/syntseis_20000101_seismic_depth_stack.segy'), PosixPath('/usr/src/webviz-subsurface-testdata/observed_data/seismic/syntseis_20030101_seismic_depth_stack.segy')]}).plugin_layout(contact_person=None)
                  ],
            ),
            dcc.Tab(id="surface_with_seismic_cross-section",label="Surface with seismic cross-section",
                selected_className="selectedButton",
                className="styledButton",children=[
                  standard_plugins.SurfaceWithSeismicCrossSection(app=app, **{'segyfiles': [PosixPath('/usr/src/webviz-subsurface-testdata/observed_data/seismic/syntseis_20000101_seismic_depth_stack.segy'), PosixPath('/usr/src/webviz-subsurface-testdata/observed_data/seismic/syntseis_20030101_seismic_depth_stack.segy')], 'surfacefiles': [PosixPath('/usr/src/webviz-subsurface-testdata/reek_fullmatrix/realization-0/iter-0/share/results/maps/topupperreek--ds_extracted_horizons.gri'), PosixPath('/usr/src/webviz-subsurface-testdata/reek_fullmatrix/realization-0/iter-0/share/results/maps/topmidreek--ds_extracted_horizons.gri'), PosixPath('/usr/src/webviz-subsurface-testdata/reek_fullmatrix/realization-0/iter-0/share/results/maps/toplowerreek--ds_extracted_horizons.gri'), PosixPath('/usr/src/webviz-subsurface-testdata/reek_fullmatrix/realization-0/iter-0/share/results/maps/baselowerreek--ds_extracted_horizons.gri')], 'surfacenames': ['Top Upper Reek', 'Top Middle Reek', 'Top Lower Reek', 'Base Lower Reek']}).plugin_layout(contact_person=None)
                  ],
            ),
            dcc.Tab(id="surface_with_grid_cross-section",label="Surface with grid cross-section",
                selected_className="selectedButton",
                className="styledButton",children=[
                  standard_plugins.SurfaceWithGridCrossSection(app=app, **{'gridfile': PosixPath('/usr/src/webviz-subsurface-testdata/reek_history_match/realization-0/iter-0/share/results/grids/geogrid.roff'), 'gridparameterfiles': [PosixPath('/usr/src/webviz-subsurface-testdata/reek_history_match/realization-0/iter-0/share/results/grids/geogrid--poro.roff'), PosixPath('/usr/src/webviz-subsurface-testdata/reek_history_match/realization-0/iter-0/share/results/grids/geogrid--perm.roff'), PosixPath('/usr/src/webviz-subsurface-testdata/reek_history_match/realization-0/iter-0/share/results/grids/geogrid--facies.roff')], 'surfacefiles': [PosixPath('/usr/src/webviz-subsurface-testdata/reek_history_match/realization-0/iter-0/share/results/maps/topupperreek--ds_extracted_horizons.gri'), PosixPath('/usr/src/webviz-subsurface-testdata/reek_history_match/realization-0/iter-0/share/results/maps/topmidreek--ds_extracted_horizons.gri'), PosixPath('/usr/src/webviz-subsurface-testdata/reek_history_match/realization-0/iter-0/share/results/maps/toplowerreek--ds_extracted_horizons.gri'), PosixPath('/usr/src/webviz-subsurface-testdata/reek_history_match/realization-0/iter-0/share/results/maps/baselowerreek--ds_extracted_horizons.gri')], 'surfacenames': ['Top Upper Reek', 'Top Middle Reek', 'Top Lower Reek', 'Base Lower Reek']}).plugin_layout(contact_person=None)
                  ],
            ),
            dcc.Tab(id="surface_viewer_fmu",label="Surface viewer (FMU)",
                selected_className="selectedButton",
                className="styledButton",children=[
                  standard_plugins.SurfaceViewerFMU(app=app, **{'ensembles': ['iter-0', 'iter-3'], 'wellfolder': PosixPath('/usr/src/webviz-subsurface-testdata/observed_data/wells'), 'attribute_settings': {'stoiip': {'min': 0, 'max': 2, 'color': 'inferno'}}}).plugin_layout(contact_person=None)
                  ],
            ),
            dcc.Tab(id="well_cross-section_fmu",label="Well cross-section (FMU)",
                selected_className="selectedButton",
                className="styledButton",children=[
                  standard_plugins.WellCrossSectionFMU(app=app, **{'ensembles': ['iter-0', 'iter-3'], 'wellfolder': PosixPath('/usr/src/webviz-subsurface-testdata/observed_data/wells'), 'surfacefiles': ['topupperreek--ds_extracted_horizons.gri', 'topmidreek--ds_extracted_horizons.gri', 'toplowerreek--ds_extracted_horizons.gri', 'baselowerreek--ds_extracted_horizons.gri'], 'surfacenames': ['Top Upper Reek', 'Top Middle Reek', 'Top Lower Reek', 'Base Lower Reek'], 'zonelog': 'Zonelog', 'zmin': 1500.0, 'zmax': 1700.0, 'marginal_logs': ['Poro', 'Perm'], 'nextend': 20}).plugin_layout(contact_person=None)
                  ],
            ),
            dcc.Tab(id="rft_plotter",label="RFT plotter",
                selected_className="selectedButton",
                className="styledButton",children=[
                  standard_plugins.RftPlotter(app=app, **{'ensembles': ['iter-0', 'iter-1', 'iter-2', 'iter-3'], 'formations': PosixPath('/usr/src/webviz-subsurface-testdata/reek_history_match/share/results/tables/formations.csv'), 'faultlines': PosixPath('/usr/src/webviz-subsurface-testdata/reek_history_match/share/results/polygons/faultpolygons.csv')}).plugin_layout(contact_person=None)
                  ],
            ),
            dcc.Tab(id="last_page",label="Horizon Uncertainty Viewer",
                selected_className="selectedButton",
                className="styledButton",children=[
                  standard_plugins.HorizonUncertaintyViewer(app=app, **{'basedir': PosixPath('/usr/src/webviz-subsurface-testdata/horizon_uncertainty_data/simple_model'), 'planned_wells_dir': PosixPath('/usr/src/webviz-subsurface-testdata/horizon_uncertainty_data/additional_wells')}).plugin_layout(contact_person=None)
                  ],
            )],
    )
